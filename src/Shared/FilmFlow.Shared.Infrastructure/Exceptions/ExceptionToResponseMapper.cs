...
using FilmFlow.Shared.Abstractions.Exceptions.Errors;
...
internal class ExceptionToResponseMapper : IExceptionToResponseMapper
{
    ...
    {
        FilmFlowException ex => GetExceptionResponse(ex), 
    ...
    private static ExceptionResponse GetExceptionResponse(FilmFlowException ex)
    {
