...
using MovieFlow.Shared.Infrastructure.Auth.Exceptions;

namespace MovieFlow.Shared.Infrastructure.Auth;
...
public static class Extensions
{
        ...
        Action<JwtBearerOptions> optionsFactory = null)
    {
        ...
        if (string.IsNullOrWhiteSpace(options.IssuerSigningKey))
            throw new MissingIssuerSigningKeyException(nameof(options.IssuerSigningKey));
