...
internal sealed class Movie
{
    ...
    private Movie(Title title, Description description, ReleaseYear releaseYear, Rating rating, CreatedAt createdAt)
    {
        Id = Guid.NewGuid();
        Title = title;
    ...
    public static Movie Create(string title, string description, int releaseYear, double rating, DateTimeOffset createdAt)
