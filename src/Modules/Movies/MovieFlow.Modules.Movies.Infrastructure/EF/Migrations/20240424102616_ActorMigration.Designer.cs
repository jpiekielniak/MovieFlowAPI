...
namespace MovieFlow.Modules.Movies.Infrastructure.EF.Migrations
{
    ...
    [Migration("20240424102616_ActorMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieFlow.Modules.Movies.Core.Movies.Entities.Actor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ActorMovie", b =>
                {
                    b.HasOne("MovieFlow.Modules.Movies.Core.Movies.Entities.Actor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieFlow.Modules.Movies.Core.Movies.Entities.Photo", b =>
                {
                    b.HasOne("MovieFlow.Modules.Movies.Core.Movies.Entities.Actor", "Actor")
                        .WithMany("Photos")
